      ...
      <div className="px-6 lg:w-5/6 xl:w-4/6 py-10 mx-auto">
        <div className="space-y-12 text-md md:text-lg text-gray-500 pb-4 md:pb-8">
          ...
          <h2 className="text-4xl font-bold leading-[1.15] 
                ...
                AntarDarpan: Unleashing the Power of AI for Personal Insight
            </h2>
          ...
          <div className="space-y-2">
            ...
            <p  className="text-gray-800">
            With AntarDarpan, you can effortlessly track your emotional journey through the historical mood tracking feature.
          ...
          <div className="space-y-2">
            ...
            AntarDarpan employs robust security measures to ensure that your journal entries remain confidential.
          ...
          <div className="space-y-2">
            ...
            AntarDarpan boasts an intuitive and user-friendly interface, 
